    ...
    public static class CoreStyles
    {
        ...
        public static void Initialize()
        {
            try
            {
                ...
                CoreStyles.berryArea = new GUIStyle(EditorStyles.textArea);
//            CoreStyles.berryArea.normal.background = EditorIcons.GetBuildInIcon("BerryArea");
                CoreStyles.berryArea.border = new RectOffset(4, 4, 5, 3);
                CoreStyles.berryArea.margin = new RectOffset(2, 2, 2, 2);
                CoreStyles.berryArea.padding = new RectOffset(2, 2, 2, 2);
